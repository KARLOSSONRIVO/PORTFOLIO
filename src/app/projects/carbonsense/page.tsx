...
export default function CarbonSensePage() {
  return (
    <div className="pt-28 sm:pt-32 pb-16 sm:pb-24 max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <h1 className="text-3xl xs:text-4xl md:text-6xl font-bold tracking-tight mb-6">CarbonSense</h1>
      <p className="text-lg sm:text-xl text-green-400 mb-8 sm:mb-12">Intelligent Carbon Footprint Tracking</p>
