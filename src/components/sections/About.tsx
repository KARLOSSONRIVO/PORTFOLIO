export function About() {
  return (
    <section id="about" className="py-20 sm:py-24 md:py-32 section-px bg-surface relative">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 sm:gap-14 md:gap-24 items-center">
        ...
        <div className="w-full md:w-1/2 min-w-0">
          <h2 className="font-headline font-black text-heading uppercase tracking-tighter mb-5 sm:mb-8 leading-tight">
            About <br /><span className="text-primary">Me</span>
          </h2>
          <div className="space-y-4 sm:space-y-6 font-body text-base sm:text-lg text-on-surface-variant leading-relaxed">
            <p>
          ...
          <div className="mt-8 pt-6 sm:mt-12 sm:pt-8 border-t border-outline-variant/30 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
            <div>
